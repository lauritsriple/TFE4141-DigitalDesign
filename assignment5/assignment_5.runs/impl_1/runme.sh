...
HD_PWD='/home/sindre/Documents/NTNU/16-2/TFE4141/assignments/assignment5/assignment_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mega_adder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mega_adder.tcl -notrace
